...
def render_html(data: dict[str, Any]) -> str:
    ...
    parts = [
        ...
        '<div style="font-size:15px;line-height:22px;font-weight:700;margin-top:6px;opacity:0.96;">GitHub Releases Monitor</div>',
        '<div style="font-size:30px;line-height:36px;font-weight:bold;margin-top:6px;">GitHub Releases Digest</div>',
        ...
        '<div style="margin:0;">Branding: <a href="https://www.firmade.ai" style="color:%s;text-decoration:none;font-weight:600;">www.FirmaDe.AI</a></div>'
        '</td></tr>' % (MUTED, ACCENT, ACCENT),
